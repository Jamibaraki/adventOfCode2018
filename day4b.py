...
for guard in guards:
    ...
    currentInfo = []
    currentInfo.append( guard[0 ]) #append his id
    currentInfo.append( biggestMin )
    currentInfo.append( mostSleep )
    if mostSleep > recordSleepMinutes:
        recordGuard = guard[0]
        recordSleepMinutes = mostSleep
        recordResult = biggestMin * guard[0]
